...
const Success: React.FC = () => {
    ...
    return (
        ...
        >
            <Box style={{backgroundColor: 'black',position: 'absolute', zIndex: 2, opacity: 0.35, width: '100%', height: '100%', alignItems: 'center'}}></Box>
            <img src={firePeople} style={{height: '88%', position: 'absolute', zIndex: 1, width: '100%'}}></img>
            <Box style={{marginLeft: undefined, width: '100%', alignItems: 'center', display: 'flex', flexDirection: 'column'}}>
